...
\begin{tikzpicture}[remember picture, overlay,
    ...
    \node[annot, below=1em of percent] (annot_percent) {範圍};
    \node[annot, below=2.5em of s]       (annot_s)       {命令};
    \node[annot, below=1em of pattern] (annot_pattern) {查找目標};
    \node[annot, below=2.5em of text]    (annot_text)    {替換內容};
    \node[annot, below=1em of g]       (annot_g)       {全域標誌};
